      ...
      <div className="mx-auto flex h-20 max-w-[1600px] items-center justify-between px-6">
        ...
        <div className="hidden md:flex flex-1 items-center justify-center px-12">
          ...
          >
            ...
            <input
              ...
              className="block w-full rounded-full border border-white/10 bg-[#141414] py-3 pl-11 pr-4 text-sm text-zinc-200 placeholder:text-zinc-500 focus:bg-[#1a1a1a] focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all shadow-inner"
        ...
        <div className="flex items-center gap-8">
          ...
          <a
            ...
            className="group flex flex-col items-center justify-center gap-0.5 rounded-xl bg-[#10b981] px-6 py-2 text-sm font-bold text-white shadow-lg transition-all hover:bg-[#059669] hover:-translate-y-0.5 active:scale-95 animate-pulse-glow"
          >
            ...
            <span className="text-[10px] font-medium text-emerald-100/90 tracking-wide group-hover:text-white transition-colors">
              +3.500 membros
            </span>
          </a>
        </div>
